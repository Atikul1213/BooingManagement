...
[NopSchemaMigration("2025/09/16 10:47:55:1687541", "Slot Booking Product create table schema migration", MigrationProcessType.Update)]

public class SlotBookingProductSchemaMigration : ForwardOnlyMigration
{
    ...
    {
        if (!Schema.Table(TableName<SlotBookingProduct>()).Exists())
